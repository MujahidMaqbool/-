...
import { Configurations, DiscountType, SaleArea, SchedulerOptions } from '@app/helper/config/app.config';
import { CustomerType, EnumBookingStatusType, EnumSaleStatusType, ENU_DateFormatName, ENU_Package, PeriodIntervals, POSItemType } from '@app/helper/config/app.enums';
import { Messages } from '@app/helper/config/app.messages';
import { SchedulerServicesApi, SaleApi } from '@app/helper/config/app.webapi';
import { ApiResponse } from '@app/models/common.model';
import { POSCartItem, POSSaleDetail, RemainingSessionDetail, SaleInvoice } from '@app/point-of-sale/models/point.of.sale.model';
import { CustomerMembership, SchedulerServiceModel, SchedulerServicesPackage, ServiceBenefitsPackage, ServiceBookingList, ServiceClient } from '@app/scheduler/models/service.model';
